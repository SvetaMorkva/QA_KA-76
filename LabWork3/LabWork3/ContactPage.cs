    ...
    public class ContactPage
    {
        ...
        public ContactPage DeleteTasks(int amount2Delete)
        {
            ...
            for (int i = 1; i < amount2Delete + 1; i++)
            {
                ...
                Thread.Sleep(10000);
                new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementIsVisible(By.CssSelector(CONFIRM_TASK_DELETION_CSS)));
        ...
        public GoogleSearchResultsPage SearchInGoogle()
        {
            ...
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(SEARCH_IN_GOOGLE_BUTTON_CSS)));
        ...
        public ContactPage LogMeeting(String meetingDesription)
        {
            ...
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(ADD_MEETING_EVENT_BUTTON_CSS)));
            AddMeetingButton.Click();
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(EVENT_TITLE_FIELD_CSS)));
            eventTitleField.SendKeys(meetingDesription);

            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(SAVE_EVENT_BUTTON_CSS)));
        ...
        {
            createEventButton.Click();
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(ADD_CALL_EVENT_BUTTON_CSS)));
            addCallButton.Click();
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(EVENT_TITLE_FIELD_CSS)));
            eventTitleField.SendKeys(meetingDesription);
        ...
        {
            createEventButton.Click();
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(ADD_EMAIL_EVENT_BUTTON_CSS)));
        ...
        {
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementIsVisible(By.CssSelector(ALL_EVENTS_TITLES_CSS)));
            Thread.Sleep(10000);
            return allEvents;
        }
