...
namespace LabWork3.Pages
{
    public class ContactsListPage
    {
        ...
        public ContactPage AddContact(String firstName, String lastName, String email, String jobTitle = "", String phoneNumber = "")
        {
            ...
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(EMAIL_FIELD_CSS)));

            emailField.SendKeys(email);
            firstnameField.SendKeys(firstName);
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(JOBTITLE_FIELD_CSS)));

            jotTitleField.SendKeys(jobTitle);
            phoneField.SendKeys(phoneNumber);

            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(CREATE_BUTTON_CSS)));
            createButton.Click();
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementIsVisible(By.CssSelector(ContactPage.CONTACT_TITLE_CSS)));
        ...
        public ContactsListPage DeleteContacts(int amount2Delete)
        {
            ...
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(DELETE_CONTACTS_BUTTON_CSS)));
            deleteContacts.Click();
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(CONFIRT_DELETION_TEXTAREA_CSS)));
            confirmDeleteion.SendKeys(amount2Delete.ToString());
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(DELETE_BUTTON_CSS)));
            deleteButton.Click();
            Thread.Sleep(2000);
        ...
        public ContactPage OpenContactPage(int contactID)
        {
            ...
            new WebDriverWait(_driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(ContactPage.CREATE_TASK_BUTTON_CSS)));
            return new ContactPage(_driver);
        }
