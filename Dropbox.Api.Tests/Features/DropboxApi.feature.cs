...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Get metadata")]
        [NUnit.Framework.CategoryAttribute("Get")]
        public virtual void GetMetadata()
        {
            string[] tagsOfScenario = new string[] {
                    "Get"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get metadata", null, new string[] {
                        "Get"});
#line 19
this.ScenarioInitialize(scenarioInfo);
#line hidden
